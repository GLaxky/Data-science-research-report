...
filePathPart1 = "C:/Users/Administrator/Desktop/总天涯心态词"
...
ax.plot(x, y1, '-', color="r", label='天涯——"忧虑类"心态词')
ax.plot(x, y2, '-', color="y", label='天涯——"希望类"心态词')
ax.plot(x, y3, '-', color="g", label='天涯——"害怕类"心态词')
ax.plot(x, y4, '-', color="brown", label='天涯——"理智类"心态词')
